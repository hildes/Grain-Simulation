...
Vecteur3D PortionPlan::get_eL() const{ return direction_longueur.get_normale();}

double PortionPlan::get_largeur() const{return largeur;}

double PortionPlan::get_longueur()const { return longueur;}
